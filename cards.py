...
class BaseContact:
    ...
    def contact(self):
        return f"Wybieram numer domowy: {self.tel_priv} i dzwonię do " \
...
class BusinessContact(BaseContact):
    ...
    def workcontact(self):
        return f"Wybieram numer służbowy: {self.tel_work} i dzownię do " \
               f"{self.first_name} {self.last_name}"

    def __repr__(self):
        return f"{self.first_name} {self.last_name}, " \
               f"{self.email_address}, {self.occupation}, {self.company}"
